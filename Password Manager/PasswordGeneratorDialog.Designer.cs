namespace PasswordManagerGUI {
    partial class PasswordGeneratorDialog {
        ...
        private void InitializeComponent() {
            ...
            this.Controls.Add(this.InputSpecialCharacters);
            this.Controls.Add(this.CheckSpecialCharacters);
            this.Controls.Add(this.CheckDigits);
            this.Controls.Add(this.CheckLowerCaseLetters);
            this.Controls.Add(this.CheckUpperCaseLetters);
